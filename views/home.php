						...
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">
									...
									Angular JS 1.8.2 & PHP
								</h3>
								<div class="card-tools">
									<ul class="nav nav-pills ml-auto">
										<li class="nav-item">
											<a class="nav-link active" href="#txt1" data-toggle="tab">TXT 1</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="#txt2" data-toggle="tab">TXT 2</a>
										</li>
									</ul>
								</div>
							</div><!-- /.card-header -->
							<div class="card-body">
								<div class="tab-content p-0">
									<div class="chart tab-pane active" id="txt1">
										<br />
										<input type="text" ng-model="your.name" placeholder="Enter a Name Here">
										<br />
										<h1>Hello {{your.name}}! \(O_O)/</h1>
									</div>
									<div class="chart tab-pane" id="txt2">
										Enter :<br />
										<div>
											<textarea id = "txtarea" class="tta" ng-model="txt" rows="30" style="position: relative; height: 100px; width: 100%;"></textarea>
										</div>
										<br />
										Show :<br />
										<div>{{txt}}</div>
...
<script type="text/javascript">
	...
	phpApp.controller('phpAppController', function neController($scope) {});
</script>